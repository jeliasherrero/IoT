...
var ledsPlugin = require('./plugins/internal/ledsPlugin'),
  ...
  picameraPlugin = require('./plugins/internal/picameraPlugin');
  lcdPlugin = require('./plugins/internal/lcdPlugin');
...
picameraPlugin.start({'simulate': false, 'frequency': 10000});
lcdPlugin.start({'simulate': false, 'frequency': 5000});
